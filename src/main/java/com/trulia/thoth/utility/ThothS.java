...
//      String query = "hostname_s:\"" + hostname + "\"" +" AND " + "coreName_s:\"" +coreName + "\" AND NOT exception_b:true AND NOT slowQuery_b:true";
//      System.out.println(query);
//      QueryResponse qr = realTimeThoth.query(new SolrQuery(query).setRows(1));
...
//      ThothS thothServers = new ThothS();
